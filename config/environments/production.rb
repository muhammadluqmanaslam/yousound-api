Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [ ENV["WEB_BASE_URL"], 'http://localhost:8080', 'https://yousound.com', /https:\/\/.*\.yousound\.com/, /https:\/\/ys-vue-prod\..*\.us-east-1\.elasticbeanstalk\.com/ ]
